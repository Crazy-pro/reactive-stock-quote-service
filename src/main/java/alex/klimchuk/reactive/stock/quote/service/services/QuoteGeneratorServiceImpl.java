...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService {
    ...
    public QuoteGeneratorServiceImpl() {
        this.quotes.add(new Quote("AAPL", 434.16));
        this.quotes.add(new Quote("TSLA", 339.74));
        this.quotes.add(new Quote("NFLX", 346.25));
        this.quotes.add(new Quote("ARKK", 224.51));
        this.quotes.add(new Quote("SQ", 156.34));
        this.quotes.add(new Quote("DIS", 567.29));
        this.quotes.add(new Quote("MFST", 190.29));
        this.quotes.add(new Quote("PLTR", 10.21));
    }
